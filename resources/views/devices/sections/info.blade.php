        ...
        <div class="space-y-4">
            ...
            <div class="pt-4 border-t border-neutral-200 dark:border-neutral-700">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <form method="POST" action="{{ route('devices.destroy', $device->public_id) }}" onsubmit="return confirm('Delete this device? This cannot be undone.');">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
                            class="inline-flex items-center px-4 py-2 rounded-lg border border-red-300 dark:border-red-700 bg-white dark:bg-neutral-800 text-sm font-medium text-red-700 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/40">
                            Delete Device
                        </button>
                    </form>
                </div>
